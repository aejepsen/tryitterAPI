        ...
        _ = builder.ConfigureServices(services =>
        {
            ...
            using (var appContext = scope.ServiceProvider.GetRequiredService<TryitterContext>())
            {
                try
                {
                  ...
                  new Student { Name = "allan", Email = "aejepsen@yahoo.com.br", Password = "12345678", Status = "Aceleração C#" },
                  new Student { Name = "pedro paulo", Email = "pedro_paulo@gmail.com", Password = "12345678", Status = "Aceleração C#" },
                  new Student { Name = "antonio", Email = "antonio@gmail.com", Password = "12345678", Status = "Aceleração C#" },
                  new Student { Name = "vitor", Email = "vitor@gmail.com", Password = "12345678", Status = "Aceleração C#" }
                  );
